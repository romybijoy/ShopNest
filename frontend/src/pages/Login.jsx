    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          <div style={{ width: 52, height: 52, background: 'var(--accent)', borderRadius: 14,
                        display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
            <Zap size={28} color="#fff" fill="#fff" />
          </div>
          <h1 style={{ fontSize: 28, fontWeight: 800, marginBottom: 6 }}>Welcome back</h1>
          <p style={{ color: 'var(--text2)', fontSize: 14 }}>Sign in to your ShopFlow account</p>
        </div>
        ...
        <div className="card">
          ...
          {/* Demo credentials */}
          <div style={{ marginTop: 20, padding: 14, background: 'var(--bg3)',
                        borderRadius: 'var(--radius-sm)', fontSize: 13 }}>
            <div style={{ color: 'var(--text2)', marginBottom: 6, fontWeight: 500 }}>Demo Credentials</div>
            <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
              <span>👤 <b>admin</b> / admin123</span>
              <span>🛍 <b>customer</b> / customer123</span>
            </div>
          </div>
        </div>
      </div>
