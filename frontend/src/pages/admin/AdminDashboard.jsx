        ...
        <>
          ...
          >
            {[
              {
                label: "Total Orders",
                value: fmt(orderStats?.totalOrders),
                color: "var(--accent)",
              },
              {
                label: "Revenue",
                value: fmtMoney(orderStats?.totalRevenue),
                color: "var(--success)",
              },
              {
                label: "Avg Order Value",
                value: fmtMoney(orderStats?.averageOrderValue),
                color: "var(--accent2)",
              },
              {
              ...
              },
              {
                ...
                value: fmt(productStats?.activeProducts),
                color: "var(--accent)",
              },
              {
                label: "Payments Collected",
                value: fmtMoney(payStats?.totalCollected),
                color: "var(--success)",
              },
            ].map((s) => (
              <div key={s.label} className="stat-card">
                <div
                  ...
                  style={{ color: s.color, fontSize: 26 }}
                >
                  {s.value}
                </div>
