    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 440 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ color: 'var(--text2)', fontSize: 14 }}>Join ShopFlow today</p>
        </div>
        ...
        <div className="card">
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <button className="btn btn-primary" type="submit" disabled={loading} style={{ marginTop: 4, padding: '12px 0' }}>
